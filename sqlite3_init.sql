CREATE TABLE IF NOT EXISTS user(user_id INTEGER PRIMARY KEY AUTOINCREMENT, user_name VARCHAR(30), user_hash VARCHAR(64), user_email VARCHAR(100), user_discriminant INTEGER, user_picture_token VARCHAR(64));
